...
M.config = function()
    ...
    local lazy = term:new():setup{
        cmd = "lazygit",
        dimensions = {height = 0.9, width = 0.9, x = 0.5, y = 0.3}
    }

    local function is_installed(exe) return vim.fn.executable(exe) == 1 end
